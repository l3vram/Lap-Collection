...
class DPTheme: NSObject {
    ...
    internal static func customizeNavigationBar(
        ...
        let font1 = UIFont(name: fontName, size: fontSize + 7)
        if ((font) != nil) {
            UINavigationBar.appearance().largeTitleTextAttributes = [NSAttributedString.Key.foregroundColor: textColor,NSAttributedString.Key.font: font1!]
